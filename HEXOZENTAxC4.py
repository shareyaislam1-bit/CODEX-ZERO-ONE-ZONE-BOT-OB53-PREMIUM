...
async def ArohiRefuse(owner,uid, K,V):
    ...
    2: {
        ...
        2: 1,
        3: int(uid),
        4: "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF] PRIME CITY [00FF00] GUILD BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]TELEGRAM : @Shareyabhai\n\n"
    }
    }
    return await GeneRaTePk((await CrEaTe_ProTo(fields)).hex() , '0515' , K , V)
...
async def ArohiRefuse(owner,uid, K,V):
    ...
    2: {
        ...
        2: 1,
        3: int(uid),
        4: "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]REDZED [00FF00] HEXOZENTA BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]TELEGRAM : @hexozenta\n\n"
    }
    }
    return await GeneRaTePk((await CrEaTe_ProTo(fields)).hex() , '0515' , K , V)
# Isko file ke sabse neeche (Bottom) paste karein
